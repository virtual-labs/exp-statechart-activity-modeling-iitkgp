...
function addbtnt21() {
  ...
  if (inpt21 == "") {
    ...
    var select1 = document.getElementById('selectcuract');
    const listItemopt1 = select1.getElementsByTagName("option");
    for (var i = 0; i < listItemopt1.length; i++) {
      if (listItemopt1[i].textContent == inpt21) {
        isInserted = true;
        break;
      }
    }
